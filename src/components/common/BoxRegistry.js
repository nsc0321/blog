...
export const BOX_REGISTRY = [
  ...
  {
    id: 'agent_call_api',
    name: '2. Call Agent API Box (스킬 실행)',
    category: BOX_CATEGORIES.AGENT,
    icon: Cpu,
  ...
  {
    id: 'agent_skill_edit',
    name: '7-1. Skill Edit Box (스킬 편집기)',
    category: BOX_CATEGORIES.AGENT,
    icon: Wrench,
  ...
  {
    id: 'agent_skill_test',
    name: '7-3. Skill Test Box (스킬 테스트)',
    category: BOX_CATEGORIES.AGENT,
    icon: Play,
  ...
  },
  {
    ...
    name: '8-1. Account List Box (자격증명)',
  ...
  },
  {
    ...
    name: '2. AI Market Analysis (LLM 퀀트)',
    category: BOX_CATEGORIES.TRADING,
    icon: Sparkles,
  ...
  {
    id: 'trading_order',
    name: '3. Order Execution Box (주문 집행)',
    category: BOX_CATEGORIES.TRADING,
    icon: DollarSign,
  ...
  {
    id: 'trading_setting',
    name: '5. Trading Setting Box (전략 설정)',
    category: BOX_CATEGORIES.TRADING,
    icon: Settings,
  ...
  {
    id: 'mabi_items',
    name: '2. Item Archive Box (아이템 DB)',
    category: BOX_CATEGORIES.MABINOGI,
    icon: Layers,
  ...
  {
    id: 'mabi_enchants',
    name: '3. Enchant Archive Box (인챈트 DB)',
    category: BOX_CATEGORIES.MABINOGI,
    icon: Sparkles,
  ...
  {
    id: 'mabi_batch',
    name: '4. Batch Collector Box (자동 수집)',
    category: BOX_CATEGORIES.MABINOGI,
    icon: Cpu,
